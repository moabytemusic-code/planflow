    ...
    const handleSubscribe = async () => {
        ...
        try {
            const response = await fetch('/api/stripe/checkout', {
                ...
                body: JSON.stringify({ priceId: 'price_1ShgazBa3LVp9FtONj5gynyn' }) // UPDATE THIS WITH YOUR ACTIVE PRICE ID 
            });
            ...
            <div className="grid gap-6 md:grid-cols-2">
                ...
                <Card className="shadow-lg border-t-4 border-t-purple-500">
                    ...
                    <CardContent className="space-y-6">
                        ...
                        <Button
                            variant="outline"
                            className="w-full border-purple-200 hover:bg-purple-50 dark:border-purple-900/50 dark:hover:bg-purple-900/20"
                            onClick={handleSubscribe}
                            disabled={loading || userData.subscriptionTier === 'PRO'}
                        >
                            {userData.subscriptionTier === 'PRO' ? 'Plan Active' : 'Upgrade to Pro'}
                        </Button>
                    </CardContent>
                </Card>
